...
FILES_MAC= ./src/main.cpp ./src/platform.cpp ./src/ecdsacrypto.cpp ./src/wallet.cpp ./src/transaction.cpp ./src/userdb.cpp ./src/blockdb.cpp ./src/networktime.cpp ./src/cli.cpp ./src/network/relayclient.cpp ./src/log.cpp ./src/network/p2p.cpp ./src/functions/*.cpp 
# ./src/network/*.cpp 
# ./src/network/p2p.cpp  
# ./src/util.cpp ./src/rsacrypto.cpp  
#	./src/wallet/wallet.cpp
FILES_LINUX= ./src/main.cpp ./src/platform.cpp ./src/ecdsacrypto.cpp ./src/wallet.cpp ./src/transaction.cpp ./src/blockdb.cpp ./src/networktime.cpp ./src/cli.cpp ./src/log.cpp  ./src/functions/*.cpp  ./src/network/relayclient.cpp ./src/network/p2p.cpp
...
CFLAGS_MAC= -L/usr/local/opt/openssl/lib -Bstatic -L/usr/local/lib -L./src/leveldb  -lssl -lcrypto -lboost_system -lboost_thread-mt -lboost_filesystem -lleveldb -lcurl   -std=c++11 -stdlib=libc++ -Wdeprecated -Wc++98-compat -w    `pkg-config --cflags --libs nice`  
# -lsecp256k1
