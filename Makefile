...
FILES_MAC= ./src/main.cpp ./src/platform.cpp ./src/ecdsacrypto.cpp ./src/wallet.cpp ./src/transaction.cpp ./src/userdb.cpp ./src/blockdb.cpp ./src/networktime.cpp ./src/cli.cpp ./src/network/relayclient.cpp ./src/network/p2p.cpp ./src/functions/*.cpp 
# ./src/network/*.cpp 
# ./src/network/p2p.cpp  
# ./src/util.cpp ./src/rsacrypto.cpp  
#	./src/wallet/wallet.cpp
FILES_LINUX= ./src/main.cpp ./src/platform.cpp ./src/ecdsacrypto.cpp ./src/wallet.cpp ./src/transaction.cpp ./src/blockdb.cpp ./src/networktime.cpp ./src/cli.cpp  ./src/functions/*.cpp  ./src/network/relayclient.cpp ./src/network/p2p.cpp
